    ...
    >
      {closeButton && (
        <button
          type="button"
          onClick={handleClose}
          className="absolute top-1 end-1 z-10 rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2"
...
type MapControlsProps = {
  /** Position of the controls on the map (default: "bottom-end") */
  position?:
    | "top-left"
    | "top-right"
    | "bottom-left"
  ...
  /** Localized labels for control buttons */
  labels?: {
    zoomIn: string;
    zoomOut: string;
    locate: string;
...
function MapControls({
  ...
  const controlLabels = labels ?? defaultControlLabels;
