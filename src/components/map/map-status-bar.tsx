...
export function MapStatusBar({
  ...
  return (
    <div className="flex items-center gap-4 rounded-lg bg-md3-surface-container-low/90 px-4 py-2 backdrop-blur-sm">
      ...
      <div className="h-4 w-px bg-md3-outline-variant/20" />
